...
```bash
➜ npm run --list
Scripts available in @100stacks/aws-cloudfront-deploy-fullstack@1.0.0 via `npm run-script`:
  frontend:dev
...
![aws region](https://github.com/user-attachments/assets/8538608b-a155-4b35-a3b3-858b81c1c2ad)
